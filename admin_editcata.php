...
echo $array[1];
echo"
<form name='$string' method='post' action='admin_editcata.php'>	<input type='hidden' name='idtoedit' value='$editid'/>
...
if ($fp3) {
   $array = explode("::", fread($fp3, filesize("catadata/$id")));
		...
		echo"
			<form action='admin_editcata.php' method='post'><input type='hidden' name='idtoedit' value='$id'/>
